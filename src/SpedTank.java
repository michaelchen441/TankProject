...
public class SpedTank extends AITank {

	public SpedTank(TankType inType, int x, int y, Wall[][] walls) {
		super(inType, x, y, walls);
		// TODO Auto-generated constructor stub
	}
	//Need to figure out mechanism by which AI Tank Moves
		void move()
		{
			//this motherf*cker is a stationary bitch
		}
